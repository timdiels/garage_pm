...
class TaskDetailsView(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.planned_start_label = QLabel('Start (planned)')
        self.planned_start_edit = QDateTimeEdit()
        self.planned_start_edit.setCalendarPopup(True)
        self.planned_start_edit.setDisplayFormat(config.qt_date_time_format)
        self.planned_start_override_edit = QCheckBox('Override')
        planned_start_layout = QHBoxLayout()
        planned_start_layout.addWidget(self.planned_start_edit)
        planned_start_layout.addWidget(self.planned_start_override_edit)
        
        self.planned_end_label = QLabel('End (planned)')
        self.planned_end_edit = QDateTimeEdit()
        self.planned_end_edit.setReadOnly(True)
        self.planned_end_edit.setCalendarPopup(True)
        self.planned_end_edit.setDisplayFormat(config.qt_date_time_format)
        
        self.predicted_start_label = QLabel('Start (predicted)')
        self.predicted_start_edit = QDateTimeEdit()
        self.predicted_start_edit.setReadOnly(True)
        self.predicted_start_edit.setCalendarPopup(True)
        self.predicted_start_edit.setDisplayFormat(config.qt_date_time_format)
        
        self.predicted_end_label = QLabel('End (predicted)')
        self.predicted_end_edit = QDateTimeEdit()
        self.predicted_end_edit.setReadOnly(True)
        self.predicted_end_edit.setCalendarPopup(True)
        self.predicted_end_edit.setDisplayFormat(config.qt_date_time_format)
        ...
        layout.addRow(self.planned_start_label, planned_start_layout)
        layout.addRow(self.planned_end_label, self.planned_end_edit)
        layout.addRow(self.predicted_start_label, self.predicted_start_edit)
        layout.addRow(self.predicted_end_label, self.predicted_end_edit)
